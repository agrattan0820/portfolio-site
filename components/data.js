export const projectsList = [
  {
    ...
    longDescription:
      "Appointed as a club officer for the Pitt Computer Science Club, both to support initiatives and to redesign the club website.\nBesides upgrading the technology from an outdated Jekyll site to a modern Gatsby site, we wanted the design to represent the student spirit of Pitt Computer Science Club.\nI iterated with different designs, gaining feedback from members on how the club should be displayed.\nSome new things I experimented with this project were svg animations and SEO analysis using Google Search Console, Google Analytics, and Hotjar.",
  ...
  },
  {
    ...
    longDescription:
      "his was built for Pitt CSC Hacks, a competition sponsored by the University of Pittsburgh's Computer Science Club and was my first time participating in a coding competition. Going into this experience I was quite nervous.\nI stuck to my guns and went with an idea that I had the past summer which was for a website that helps guide students as to analyzing their financial aid package based on information about the school.\nI ended up finding a partner who didn't know much about web development but was willing to work with me in developing this idea.\nThis was first foray into handling large amounts of data and trying to contextualize it for a user. If I were to fix one thing about the site, it would be effectively distinguishing the grades between each other so that a user's result is crystal clear.",
